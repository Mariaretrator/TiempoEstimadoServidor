package dulceramos.entrypoint.gui;

import dulceramos.adaptadores.red.ObservadorServidor;
...
public class ServidorFrame extends JFrame implements ObservadorServidor {
    ...
    public ServidorFrame(final GestionarServidorInputPort gestionarServidorPort) {
        super("Servidor UDP - Tiempo Estimado de Viaje (Arquitectura Hexagonal / SOLID)");
    ...
    private JPanel crearPanelNorte() {
        ...
        final JLabel lblTitulo = new JLabel("Servidor de Tiempo Estimado de Viaje (Protocolo UDP)");
