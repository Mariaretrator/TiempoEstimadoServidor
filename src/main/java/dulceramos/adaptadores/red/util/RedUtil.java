package dulceramos.adaptadores.red.util;
 ...
 * única: Detección y resolución de la dirección IP local del host.
 */
public final class RedUtil {
     ...
     * conectividad externa, retorna la dirección de loopback del sistema.
     */
